...
- `Search_results_v2.csv`: current macro benchmark, using in-task nanosecond timing, five trials, five counterbalanced configurations, and a 120-second timeout.
